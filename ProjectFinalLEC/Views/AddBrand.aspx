<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Template.Master" AutoEventWireup="true" CodeBehind="AddBrand.aspx.cs" Inherits="ProjectFinalLEC.Views.AddBrand" %>
    ...
    <div class="container">
        <div class="form-container">
            <div class="heading-container">
                <h2 class="centered-heading">Add Brand</h2>
            </div>
            ...
            <asp:Label ID="BrandImageLBL" runat="server" Text="Brand Image"></asp:Label>
