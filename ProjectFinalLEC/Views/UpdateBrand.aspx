<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Template.Master" AutoEventWireup="true" CodeBehind="UpdateBrand.aspx.cs" Inherits="ProjectFinalLEC.Views.UpdateBrand" %>
            ...
            <div class="flex-right-gig">
                <asp:Panel ID="BtnPanel" runat="server" >
                    <div class="d-flex flex-column ">
                        ...
                        <br />
                        <asp:Button ID="CancelBtn" runat="server" Visible="false" class="btn btn-outline-warning mb-3" Text="Cancel" OnClick="CancelBtn_Click" />
